...
model_feture_old = ['lnVs30', 'MW', 'lnRrup', 'fault.type', 'STA_Lon_X', 'STA_Lat_Y']
...
o5 = np.swapaxes(result_SMOGN[0],0,1)[5]
...
ax4.set_yticks([1,2,3])
ax5.boxplot(o4)
ax5.set_xticklabels(['STA_Lon_X'])
ax6.boxplot(o5)
ax6.set_xticklabels(['STA_Lat_Y'])
