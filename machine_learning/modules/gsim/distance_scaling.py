...
model_path = "../../XGB/model/XGB_PGA.json"
...
# plt.plot(ctx['rrup'], lin_mean[0] - lin_sig[0], 'g--')
plt.plot(ctx['rrup'], abr_mean[0], 'b', linewidth='0.8', label="Abrahamson2014")
# plt.plot(ctx['rrup'], abr_mean[0] + abr_sig[0], 'r--')
# plt.plot(ctx['rrup'], abr_mean[0] - abr_sig[0], 'r--')
plt.plot(ctx['rrup'], cam_mean[0], 'yellow', linewidth='0.8', label="CampbellBozorgnia2014")
# plt.plot(ctx['rrup'], cam_mean[0] + choa_sig[0], 'r--')
# plt.plot(ctx['rrup'], cam_mean[0] - choa_sig[0], 'r--')
plt.plot(ctx['rrup'], choa_mean[0], 'pink', linewidth='0.8', label="ChaoEtAl2020Asc")
...
plt.legend()
plt.savefig(f"distance scaling compare.jpg", dpi=300)
plt.show()